...
def main():
    ...
    for model_name in models:
      ...
      for seed in range(num_seeds):
        ...
        training_args = TrainingArguments(
            output_dir=output_dir, logging_steps=200, save_steps=0, report_to='wandb', seed=seed, )
    ...
    best_model_path = './content/drive/MyDrive/ANLPEx1/output/' + model_highest_mean_accuracy + "/" + str(best_seed) + "/" + "model.pth"
